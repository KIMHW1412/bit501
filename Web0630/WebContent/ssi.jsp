...
<body>
	...
	int Gsabun, Gsize; //사번,급여
	String Gname, Gtitle, Gpwd, Gfile, Gjuso1, Gjuso2, Gphone, Gemail, Gurl, Gcontent; //이름,제목
	...
	<%
		...
		try {
			...
			CN = DriverManager.getConnection(url, "system", "orcle");
			//System.out.println("DB서버연결성공 OKOK");
		} catch (Exception ex) {
			System.out.println("DB실패:" + ex);
		}
	%>
</body>
</html>
